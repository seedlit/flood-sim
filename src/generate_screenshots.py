...
def save_water_logged_img(
    rgb_tif_path, src_shp_path, out_dir, shp_transparency_factor, width=12, height=9
):
    try:
        ...
        ep.plot_rgb(
            ...
            rgb=[0, 1, 2],
            ax=ax,
            title="Water logging at elevation: {}; Area flooded: {} metres square".format(
                water_level, flooded_area
            ),
